...
var projects = [{
	...
	"imgCap": ["A no-Gi class picture, every thursday", "My professor's Logo", "My recent victory, at the Manchester Open"],
	"location": "Eccles, Manchester, M30 0UT"
}, {
	"name": "Solar System",
	"years": "2015",
	"description": "Information about the Solar System",
	"images": ["images/solar2.jpg"],
	"imgCap": ["Learn about the Solar System, Click on an image to find out more"],
	...
	for (prj in projects) {
		...
		*/
		...
		for (img in projects[prj].images) {
			var cjm = HTMLprojectImageX.replace("%data%", projects[prj].images[img]);
			cjm = cjm.replace("%caption%", projects[prj].imgCap[img]);
			$(".project-entry:last").append(cjm);
